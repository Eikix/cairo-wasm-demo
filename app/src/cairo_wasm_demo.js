 ...
 */
export function runProveAndVerify() {
    const ret = wasm.runProveAndVerify();
    if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_e498a1d24165b060 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cairo_wasm_demo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
